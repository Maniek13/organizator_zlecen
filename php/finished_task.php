...
try{
	...
	if ($polaczenie->connect_errno!=0) {
		...
		$sql = "SELECT * FROM tasks LEFT JOIN taskCategory ON categoryId  = catId LEFT JOIN workers ON workersId  = workerId WHERE  workerId = '$id' and status = '1' ORDER BY taskId ASC";
